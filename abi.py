...
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' ''')
time.sleep(0.2)
print('\033[90m        []™ WELCOME TO PRIVAT TOOLS AbiSinatria ™[] [] ™TERMUX VERSION™ []\033[0m')
...
for x in range(80):
    ...
    if count == 3:
        ...
        load += '[•]'
os.system('clear')
os.system('xdg-open https://www.instagram.com/abi_sinatria/')
import os, sys, random, time, getpass
from time import sleep
username = 'abisinatria'
password = 'chk'

def masuk():
               os.system('clear')
               print('[+] LOGIN CHK_ID BY KENTODCHECKER [+]')
               print('=====FOLLOW IG DULU UNTUK TAHU USERNAME DAN PASSWORD=====')
               print('')
               ...
               if uname == username:
                            ...
                            os.system('xdg-open https://m.me/abi.sinatriaku')
                            exit()
masuk()
